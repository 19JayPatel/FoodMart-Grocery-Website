<%@ Page Title="" Language="C#" MasterPageFile="~/User/User.Master" AutoEventWireup="true" CodeBehind="index.aspx.cs" Inherits="FoodMart_Pro.User.index" %>
                ...
                <div
                    ...
                    <div class="cart text-end d-none d-lg-block dropdown">
                        <button class="border-0 bg-transparent d-flex flex-column gap-2 lh-1" type="button"
                            data-bs-toggle="offcanvas" data-bs-target="#offcanvasCart" aria-controls="offcanvasCart" onclick="document.location='addtocart.html'">
                            <span class="fs-6 text-muted dropdown-toggle">Your Cart</span> <span class="cart-total fs-5 fw-bold">₹1290.00</span>
                        </button>
                    </div>
                </div>
            </div>
                ...
                <div class="d-flex  justify-content-center justify-content-sm-between align-items-center">
                    <nav class="main-menu d-flex navbar navbar-expand-lg">
                        ...
                        <div class="offcanvas offcanvas-end" tabindex="-1" id="offcanvasNavbar"
                            ...
                            <div class="offcanvas-body">
                                ...
                                <ul class="navbar-nav justify-content-end menu-list list-unstyled d-flex gap-md-3 mb-0">
                                    ...
                                    <li class="nav-item dropdown"><a href="" class="nav-link">Products</a> </li>
                        ...
                        <div class="d-flex align-items-center justify-content-end" style="margin-left: 700px;">
                            ...
                            <!-- Logout Button -->
                            <asp:LinkButton ID="btnLogout" runat="server" CssClass="btn btn-link" Style="color: red;"
                    ...
                    <div class="category-carousel swiper">
                        <div class="swiper-wrapper">
                            <a href="index.html" class="nav-link category-item swiper-slide">
                                <img src="images/icon-vegetables-broccoli.png" alt="Vegetables">
                                <h3 class="category-title">Fruits & Veggies</h3>
                            </a>

                            <a href="index.html" class="nav-link category-item swiper-slide">
                                <img src="images/icon-bread-baguette.png" alt="Bread & Sweets">
                                <h3 class="category-title">Breads & Sweets</h3>
                            </a>

                            <a href="index.html" class="nav-link category-item swiper-slide">
                                <img src="images/icon-soft-drinks-bottle.png" alt="Soft Drinks">
                                <h3 class="category-title">Soft Drinks</h3>
                            </a>

                            <a href="index.html" class="nav-link category-item swiper-slide">
                                <img src="images/icon-wine-glass-bottle.png" alt="Wines & Beverages">
                                <h3 class="category-title">Wines & Beverages</h3>
                            </a>

                            <a href="index.html" class="nav-link category-item swiper-slide">
                                <img src="images/icon-animal-products-drumsticks.png" alt="Meat & Poultry">
                                <h3 class="category-title">Meat & Poultry</h3>
                            </a>

                            <a href="index.html" class="nav-link category-item swiper-slide">
                                <img src="images/icon-bread-herb-flour.png" alt="Herbs & Flour">
                                <h3 class="category-title">Herbs & Flour</h3>
                            </a>

                            <a href="index.html" class="nav-link category-item swiper-slide">
                                <img src="images/icon-vegetables-broccoli.png" alt="Organic Produce">
                                <h3 class="category-title">Organic Produce</h3>
                            </a>

                            <a href="index.html" class="nav-link category-item swiper-slide">
                                <img src="images/icon-soft-drinks-bottle.png" alt="Juices">
                                <h3 class="category-title">Juices</h3>
                            </a>

                            <a href="index.html" class="nav-link category-item swiper-slide">
                                <img src="images/icon-animal-products-drumsticks.png" alt="Frozen Meats">
                                <h3 class="category-title">Frozen Meats</h3>
                            </a>

                            <a href="index.html" class="nav-link category-item swiper-slide">
                                <img src="images/icon-bread-baguette.png" alt="Bakery Items">
                                <h3 class="category-title">Bakery Items</h3>
                            </a>
                                ...
                                <div class="product-grid row row-cols-1 row-cols-sm-2 row-cols-md-3 row-cols-lg-4 row-cols-xl-5">
                                    ...
                                    <div class="col">
                                        <div class="product-item">
                                            ...
                                            <figure>
                                                <a href="index.html" title="Heinz Tomato Ketchup">
                                                    <img src="images/heinz-ketchup.png" class="tab-image" alt="Heinz Ketchup">
                                                </a>
                                            </figure>
                                            <h3>Heinz Tomato Ketchup</h3>
                                            <span class="qty">750g Bottle</span>
                                            <span class="rating">
                                    ...
                                    <div class="col">
                                        <div class="product-item">
                                            ...
                                            <span class="qty">1 Pack</span><span class="rating"><svg width="24" height="24"
                                                class="text-primary">
                                                <use xlink:href="#star-solid"></use>
                                            </svg>
                                                4.5</span>
                                    ...
                                    <div class="col">
                                        <div class="product-item">
                                            ...
                                            <figure>
                                                <a href="index.html" title="Product Title">
                                                    <img src="images/NestleEverydayDairyWhitener.jpg" class="tab-image">
                                                </a>
                                            </figure>
                                            <h3>Nestlé Everyday Dairy Whitener</h3>
                                            <span class="qty">1kg Pouch</span><span class="rating"><svg width="24" height="24"
                                                class="text-primary">
                                                <use xlink:href="#star-solid"></use>
                                            </svg>
                                                4.5</span>
                                    ...
                                    <div class="col">
                                        <div class="product-item">
                                            ...
                                            <figure>
                                                <a href="index.html" title="Product Title">
                                                    <img src="images/AashirvaadWholeWheatAtta.png" class="tab-image">
                                                </a>
                                            </figure>
                                            <h3>Aashirvaad Whole Wheat Atta</h3>
                                            <span class="qty">5kg Pack</span><span class="rating"><svg width="24" height="24"
                                                class="text-primary">
                                                <use xlink:href="#star-solid"></use>
                                            </svg>
                                                4.5</span>
                                    ...
                                    <div class="col">
                                        <div class="product-item">
                                            ...
                                            <figure>
                                                <a href="index.html" title="Product Title">
                                                    <img src="images/FreshBroccoli.png" class="tab-image">
                                                </a>
                                            </figure>
                                            <h3>Fresh Broccoli</h3>
                                            <span class="qty">500G</span><span class="rating"><svg width="24" height="24"
                                                class="text-primary">
                                                <use xlink:href="#star-solid"></use>
                                            </svg>
                                                4.5</span>
                                    ...
                                    <div class="col">
                                        <div class="product-item">
                                            ...
                                            <figure>
                                                <a href="index.html" title="Product Title">
                                                    <img src="images/BabyCarrots.png" class="tab-image">
                                                </a>
                                            </figure>
                                            <br>
                                            <h3>Baby Carrots</h3>
                                            <span class="qty">1 KG Pack</span><span class="rating"><svg width="24" height="24"
                                                class="text-primary">
                                                <use xlink:href="#star-solid"></use>
                                            </svg>
                                                4.5</span>
                                    ...
                                    <div class="col">
                                        <div class="product-item">
                                            ...
                                            <figure>
                                                <a href="index.html" title="Product Title">
                                                    <img src="images/CherryTomatoes.png" class="tab-image">
                                                </a>
                                            </figure>
                                    ...
                                    <div class="col">
                                        <div class="product-item">
                                            ...
                                            <h3>Fresh Bananas</h3>
                                            <span class="qty">12 Pices</span><span class="rating"><svg width="24" height="24"
                                                class="text-primary">
                                                <use xlink:href="#star-solid"></use>
                                            </svg>
                                                4.5</span>
                                    ...
                                    <div class="col">
                                        <div class="product-item">
                                            ...
                                            <figure>
                                                <a href="index.html" title="Product Title">
                                                    <img src="images/Potatoes.png" class="tab-image">
                                                </a>
                                            </figure>
                                            <br>
                                            &nbsp;
