<%@ Page Title="FoodMart - Contact Us Page" Language="C#" MasterPageFile="~/User/User.Master" AutoEventWireup="true" CodeBehind="Contact.aspx.cs" Inherits="FoodMart_Pro.User.Contact" %>
...
<asp:Content ID="Content6" runat="server" ContentPlaceHolderID="ContentPlaceHolder2">
    ...
    <section class="py-5">
        <div class="container">
            <div class="section-header text-center mb-5">
                <h2 class="section-title display-5">Get in <span class="text-primary">Touch</span></h2>
            ...
            <div class="row">
                    ...
                    <asp:Panel ID="pnlContactForm" runat="server">
                        ...
                        <div class="mb-3">
                            ...
                            <asp:TextBox ID="txtMessage" runat="server" CssClass="form-control"
                                placeholder="Type your message" TextMode="MultiLine" Rows="5"></asp:TextBox>
                        </div>

                        <asp:Button ID="btnSend" runat="server" Text="Send Message"
                            CssClass="btn btn-primary btn-lg" OnClick="btnSend_Click" />
                    </asp:Panel>
                </div>
                ...
                <!-- Google Map -->
                <div class="col-md-6">
                    <div class="map-responsive shadow rounded overflow-hidden">
                        <iframe
                            src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d241317.11609950865!2d72.74109899417243!3d19.082197838785915!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3be7b63c48e9f5af%3A0x2f9579ba22e1a1a2!2sMumbai%2C%20Maharashtra!5e0!3m2!1sen!2sin!4v1622536959823!5m2!1sen!2sin"
    ...
    <section class="py-5 bg-light">
        <div class="container text-center">
            ...
            <p class="text-muted mb-4">
                We’re here to assist you with anything — from order queries to delivery updates.
            </p>
            <div class="row">
                <div class="col-md-4 mb-4">
                    <div class="help-box">
                        <i class="bi bi-question-circle help-icon" style="color: #ff7f50;"></i>
                        <h5>FAQs</h5>
                        <p class="text-muted">Browse through frequently asked questions to find instant answers.</p>
                    </div>
                </div>
                <div class="col-md-4 mb-4">
                    <div class="help-box">
                        <i class="bi bi-chat-dots help-icon" style="color: #28a745;"></i>
                        <h5>Live Chat</h5>
                        <p class="text-muted">Connect with our support team in real-time during business hours.</p>
                    </div>
                </div>
                <div class="col-md-4 mb-4">
                    <div class="help-box">
                        <i class="bi bi-envelope-paper help-icon" style="color: #1e90ff;"></i>
                        <h5>Email Us</h5>
                        <p class="text-muted">
                            Reach out to us at <strong>support@foodmart.com</strong> and we’ll get
    ...
    <section class="py-5">
        <div class="container text-center">
            <h3 class="mb-4">Our Working Hours</h3>
            <p class="lead text-muted">We are open 6 days a week to deliver fresh groceries right to your door.</p>
            <div class="row justify-content-center">
                <div class="col-md-6">
                    <table class="table table-bordered mt-4 hours-table">
                        <tbody>
                            <tr>
                            ...
                            <tr>
                                <th class="closed-day">Sunday</th>
                                <td class="closed-day">Closed</td>
                            </tr>
                        </tbody>
                    </table>
                </div>
